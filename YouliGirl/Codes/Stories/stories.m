...
+(NSArray*)loadStoryByDayFlag:(NSInteger)aDayFlag {
	...
	switch (aDayFlag) {
		case 1: {
			...
			[NSArray arrayWithObjects:
			 @"face01001-scene_cinema-0-0",
			 @"2-0-0-Prologue 告白-0",
			 @"1-lt-0-那是壹次很普通的約會。-lt",
			 @"1-lt-0-相識多年的女孩祐莉，壹如往常的和我看電影。-lt",
			 @"1-lt-0-不過，就在道別時，她說了令我意想不到的話。-lt",
			 @"1-lt-0-這是，我倆新關系的開始……-lt",
			 @"1-lt-祐莉-今天謝謝你陪我。今天這部電影真好看。-bgm009",
